...
import com.zhihu.matisse.internal.loader.AllImagesLoader;

import java.lang.ref.WeakReference;

public class AlbumAllCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new AllImagesLoader(context);
    }
