...
public class MatisseActivity extends AppCompatActivity implements
    ...
    private void updateBottomToolbar() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonApply.setText(requestType==0?getString(R.string.button_apply_disable):
                    getString(R.string.button_apply_delete_disable));
        } else {
            mButtonPreview.setEnabled(true);
            mButtonApply.setEnabled(true);
            mButtonApply.setText(requestType==0?getString(R.string.button_apply, selectedCount):
