...
package com.fotki.filepicker.adapter;
...
import com.fotki.filepicker.activity.FilePickerActivity;
import com.fotki.filepicker.model.MediaFile;
import com.fotki.filepicker.utils.FilePickerProvider;
import com.fotki.filepicker.utils.TimeUtils;
import com.fotki.filepicker.view.SquareImage;
...
public class FileGalleryAdapter extends MultiSelectionAdapter<FileGalleryAdapter.ViewHolder>
    ...
    public void openCamera(boolean forVideo) {
        ...
        if (!dir.exists() && !dir.mkdir()) {
            Log.d(FilePickerActivity.TAG, "onClick: " +
